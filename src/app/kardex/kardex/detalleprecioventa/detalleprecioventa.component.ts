...
@Component({
  selector: 'app-detalleprecioventa',
  templateUrl: './detalleprecioventa.component.html',
  styleUrls: ['./detalleprecioventa.component.css']
})
export class DetalleprecioventaComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data,
    public dialogRef: MatDialogRef<DetalleprecioventaComponent>,
